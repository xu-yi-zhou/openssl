...
The default value is 0, XTS mode of the SM4 algorithm is specified by
GB/T 17964-2021. Set the parameter to 1 to use the IEEE Std.
1619-2007 variant of XTS-SM4.
