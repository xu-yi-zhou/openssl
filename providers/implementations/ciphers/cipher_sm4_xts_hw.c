...
//         stream_enc = HWSM4_xts_encrypt;
// # endif /* HWSM4_xts_encrypt */
// # ifdef HWSM4_xts_decrypt
//         stream_dec = HWSM4_xts_decrypt;
// # endif /* HWSM4_xts_decrypt */
//         XTS_SET_KEY_FN(HWSM4_set_encrypt_key, HWSM4_set_decrypt_key,
//                        HWSM4_encrypt, HWSM4_decrypt,
...
//             stream_gb_dec = vpsm4_ex_xts_encrypt_gb;
//             stream_enc = vpsm4_ex_xts_encrypt;
//             stream_dec = vpsm4_ex_xts_encrypt;

//         XTS_SET_KEY_FN(vpsm4_set_encrypt_key, vpsm4_set_decrypt_key,
//                        vpsm4_encrypt, vpsm4_decrypt,
//                        stream_enc, stream_dec,
...
//     }
    {
        XTS_SET_KEY_FN(SM4_set_encrypt_key, SM4_set_decrypt_key,
                       SM4_encrypt, SM4_decrypt, stream_enc, stream_dec,
                       stream_gb_enc, stream_gb_dec);
    }
    return 1;
}
